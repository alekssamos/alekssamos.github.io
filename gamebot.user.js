...
(function() {
    ...
    function rooms() {
        if(!_golink("/Rooms/ExamineAll") && !_golink("/Rooms/GetPotionAll") && !_golink("/Rooms/DischargeAll") && !_golink("/Rooms/ClearAll") && !_golink("/Reception/TreatAll?treatType=Epidemic")) {
            golink("/Pharmacy");
        }
    }
    function pharmacy() {
